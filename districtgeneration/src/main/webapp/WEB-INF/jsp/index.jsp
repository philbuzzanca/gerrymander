                    ...
                    <div class="sidebar">
                        ...
                        <div id="runningAlgo" style="width:100%">
                            ...
                            <div class="form-group" style="margin: auto">
                                <button type="button" class="btn btn-secondary" id="loadMapButton" style="margin-left: 10%">Load map</button>
                                <button type="button" class="btn btn-secondary" id="saveMapButton" style="margin-left: 10%">Save map</button>
                            </div>
                        </div>
